...
import {deleteUser, getAllUsers, getUserById, setRequestService, updateProfilePicture} from '../controllers/User.Controller.js'
...
userRouter.delete('/:id', validateSchema(userIdSchema, "params"), deleteUser);
