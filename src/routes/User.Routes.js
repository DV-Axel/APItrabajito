...
import {deleteUser, getAllUsers, getPerfilByUsuarioId, setRequestService, updateProfilePicture, updateUser, selectWorker, updateDataUser} from './../controllers/User.Controller.js'
...
userRouter.get('/:id', validateSchema(idSchema, "params"), getPerfilByUsuarioId);
...
userRouter.put('/actualizar-atributo/:id', updateDataUser)
